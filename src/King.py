        ...
        if self.movesMade == 0:
            ...
            for move in otherSideMoves:
                if move.newPos == self.position:
                    inCheck = True
                    break
                if move.newPos == self.position + C(
                    1, 0
            ...
            if not inCheck:
                if (
                    not kingsideCastleBlocked
                    and not kingsideCastleCheck
                    ...
                    yield move
                if (
                    not queensideCastleBlocked
                    and not queensideCastleCheck
